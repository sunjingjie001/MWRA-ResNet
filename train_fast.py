...
def main():
	...
	check_point_path = 'E:/ResNet/ResNet/result__'+str(check_point)+'_start'
	...
	if use_tensorboard:
		...
		configure('E:/log对比/ResNet', flush_secs=5)
	...
	if check_point != 0:
		if torch.cuda.is_available():
			netResNet.load_state_dict(torch.load('E:/ResNet/ResNet/result__0_start/netResNet_epoch_' + str(check_point) + '_gpu.pth'))

		else :
			netResNet.load_state_dict(torch.load('E:/ResNet/ResNet/result__0_start/netResNet_epoch_' + str(check_point) + '_cpu.pth'))
